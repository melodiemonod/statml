...
#### PLOTS #### 
lambdas <- 10^seq(3, -2, by = -.5); lambda_ls = 1e-14
df= unlist(res)
tmp = data.frame(method = c(rep("LS", length(D_grid)), rep(paste("Ridge lambda =", round(lambdas, digits = 2)), length(D_grid)) , rep(paste("Lasso lamda =", round(lambdas, digits = 2)), length(D_grid))), 
                 D = rep(D_grid, 1+ length(lambdas)*2), 
                 ...
                 L2_norm = c(df[grepl( "ls.L2_norm", names(df))], df[grepl( "ridge.L2_norm", names(df))], df[grepl( "lasso.L2_norm", names(df))]),
...
p1.ridge = ggplot(tmp[grepl("Ridge", tmp$method),], aes(x = D, color = method)) +
...
p2.ridge = ggplot(tmp[grepl("Ridge", tmp$method),], aes(x = D, color = method)) +
...
p3.ridge =  ggplot(tmp[grepl("Ridge", tmp$method),], aes(x = D, color = method)) +
...
p4.ridge = ggplot(tmp[grepl("Ridge", tmp$method),], aes(x = D, color = method)) +
  geom_line(aes(y = L2_norm))+
  geom_point(aes(y = L2_norm), shape = 4)+
  theme_bw()+
  ylab("Norm") +
...
p5.ridge =   ggplot(tmp[grepl("Ridge", tmp$method),], aes(x = D, color = method)) +
...
p6.ridge = ggplot(tmp[grepl("Ridge", tmp$method),], aes(x = D, color = method)) +
...
p1.lasso = ggplot(tmp[grepl("Lasso", tmp$method),], aes(x = D, color = method)) +
  geom_line(aes(y = ZOL_test)) +
  geom_point(aes(y = ZOL_test), shape = 4) +
...
p2.lasso = ggplot(tmp[grepl("Lasso", tmp$method),], aes(x = D, color = method)) +
  geom_line(aes(y = MSE_test))+
  geom_point(aes(y = MSE_test), shape = 4)+
...
p3.lasso =  ggplot(tmp[grepl("Lasso", tmp$method),], aes(x = D, color = method)) +
  geom_line(aes(y = L2_norm))+
  geom_point(aes(y = L2_norm), shape = 4) +
  theme_bw()+
  ylab("Norm") +
...
p4.lasso = ggplot(tmp[grepl("Lasso", tmp$method),], aes(x = D, color = method)) +
  geom_line(aes(y = L2_norm))+
  geom_point(aes(y = L2_norm), shape = 4)+
  theme_bw()+
  ylab("Norm") +
...
p5.lasso =   ggplot(tmp[grepl("Lasso", tmp$method),], aes(x = D, color = method)) +
  geom_line(aes(y = ZOL_training))+
  geom_point(aes(y = ZOL_training), shape = 4)+
  theme_bw()+
  ylab("Train (%)") +
...
p6.lasso = ggplot(tmp[grepl("Lasso", tmp$method),], aes(x = D, color = method)) +
  geom_line(aes(y = MSE_training))+
  geom_point(aes(y = MSE_training), shape = 4)+
  theme_bw() +
  ylab("Train") +
